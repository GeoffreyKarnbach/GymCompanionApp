...
@Model public class ExerciseExecution {
    ...
    @Relationship(deleteRule: .cascade,inverse: \ExerciseExecutionSet.exerciseExecution) var exerciseExecutionSets: [ExerciseExecutionSet]?
    var exerciseInTraining: ExerciseInTraining?
    
    @Relationship(deleteRule: .cascade, inverse: \TrainingPlanExecution.exerciseExecution) var trainingPlanExecution: TrainingPlanExecution?
